---
name: impeccable
description: Create distinctive, production-grade frontend interfaces and UI design systems with strong visual direction, responsive behavior, accessible interaction, motion, UX writing, design critique, and implementation-ready component guidance. Use for websites, dashboards, applications, page layouts, components, design reviews, visual polish, or accessibility and consistency audits.
